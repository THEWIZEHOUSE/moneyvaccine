...
# 1. Video Aspect Ratios (Make them 9:16)
html = html.replace('aspect-[4/5] sm:aspect-[1/1]', 'aspect-[9/16] max-h-[70vh]')
html = html.replace('aspect-[4/5] bg-black', 'aspect-[9/16] bg-black')

# 2. Add Free Classes CTA
cta = r'''                </div>
                    ...
                    <div class="w-full md:w-5/12">
                        <div class="relative rounded-[2rem] overflow-hidden shadow-2xl">
                            ...
                            <div class="absolute bottom-6 left-6 text-white">
                                <h3 class="text-2xl font-bold">วัคซีน (Vaccine)</h3>
